...
- Copilot may also comment on the pull request on GitHub. To deal with its comments, start a new chat, paste the comment in, and ask Copilot to fix it or explain why it doesn't apply.
