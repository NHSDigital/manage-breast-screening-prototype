...
- `showReads` - When the original reads appear on the arbitration opinion page: `'on_demand'` (default) | `'blind'`
- `revealStyle` - How `on_demand` presents the reads: `'expander'` (default) | `'card'` | `'modal'` | `'tabs'`
